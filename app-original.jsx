...
const DEFAULT_PROJECTS = [
  { id:1, name:"AB2L LEX 26", color:"#3B82F6", members:["Ana Lima"], objectives:[
...
export default function App(){
  ...
  useEffect(()=>{
    (async()=>{
      try{
        const r1=await window.storage.get("ab2l-okr-v2",true);       setProjects(r1?JSON.parse(r1.value):DEFAULT_PROJECTS);
